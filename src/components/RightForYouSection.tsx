  ...
  return (
    <section className="py-16 px-6 md:px-10 bg-white border-t border-gray-100 cv-auto">
      <div className="max-w-5xl mx-auto">
        <div className="mb-10">
          <p className="text-[#1565C0] text-xs font-semibold uppercase tracking-widest mb-3">Eligibility</p>
          <h2 className="text-3xl font-bold text-[#1565C0] mb-5 leading-snug" style={{ fontFamily: '"Playfair Display", serif' }}>Is the WellPeps Telehealth Process Right for You?</h2>
          <p className="text-gray-600 text-base leading-relaxed mb-4">Telehealth care through WellPeps is designed for adults seeking convenient, clinician-guided treatment for weight loss, energy and longevity, men&apos;s health, or longevity care — without the barriers of traditional in-person clinic visits. Our process is ideal for busy professionals, parents, rural residents, and anyone who values privacy and transparent pricing.</p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-5">
          <div className="bg-[#F7F9FC] rounded-2xl p-6 border border-gray-100">
            <div className="w-10 h-10 flex items-center justify-center rounded-xl bg-[#EAF5FF] mb-4"><i className="ri-map-pin-line text-[#1565C0] text-lg"></i></div>
            <h4 className="text-sm font-bold text-gray-900 mb-2">Nationwide Availability</h4>
            <p className="text-xs text-gray-500 leading-relaxed">WellPeps serves patients across the United States. Availability varies by state, treatment pathway, provider availability, and state-specific requirements. Some states require a synchronous (live video) initial visit before prescribing.</p>
          </div>
          <div className="bg-[#F7F9FC] rounded-2xl p-6 border border-gray-100">
            <div className="w-10 h-10 flex items-center justify-center rounded-xl bg-[#EAF5FF] mb-4"><i className="ri-health-book-line text-[#1565C0] text-lg"></i></div>
          ...
          <div className="bg-[#F7F9FC] rounded-2xl p-6 border border-gray-100">
            <div className="w-10 h-10 flex items-center justify-center rounded-xl bg-[#EAF5FF] mb-4"><i className="ri-shield-check-line text-[#1565C0] text-lg"></i></div>
          ...
          <div className="bg-[#F7F9FC] rounded-2xl p-6 border border-gray-100">
            <div className="w-10 h-10 flex items-center justify-center rounded-xl bg-[#EAF5FF] mb-4"><i className="ri-time-line text-[#1565C0] text-lg"></i></div>
        ...
        <div className="mt-8 bg-[#EAF5FF] rounded-xl p-5 flex items-start gap-3">
          <div className="w-5 h-5 flex items-center justify-center flex-shrink-0 mt-0.5"><i className="ri-information-line text-[#1565C0] text-base"></i></div>
          <p className="text-sm text-[#1565C0] leading-relaxed"><strong>State-specific requirements:</strong> States including but not limited to Alabama, Arkansas, Delaware, Idaho, Indiana, Iowa, Louisiana, Mississippi, New Hampshire, New Mexico, North Carolina, Oklahoma, South Carolina, West Virginia, and Wisconsin may require a synchronous video visit for the initial prescription. This requirement is determined by state medical board regulations and applies to all telehealth platforms. Your provider will guide you through scheduling if required.</p>
        </div>
      </div>
    </section>
  );
