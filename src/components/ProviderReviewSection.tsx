  ...
  return (
    <section className="py-16 px-6 md:px-10 bg-[#F8F8F6] border-t border-gray-100 cv-auto">
      <div className="max-w-5xl mx-auto">
        <div className="mb-10">
          <p className="text-[#E8A923] text-xs font-semibold uppercase tracking-widest mb-3">The Clinical Review Process</p>
          <h2 className="text-3xl font-bold text-[#0B7A8C] mb-5 leading-snug" style={{ fontFamily: '"Playfair Display", serif' }}>What Happens During Your Provider Review?</h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-5">
          <div className="bg-white rounded-2xl p-6 border border-gray-100">
            <div className="w-10 h-10 flex items-center justify-center rounded-xl bg-[#E8F5F7] mb-4"><i className="ri-calendar-check-line text-[#0B7A8C] text-lg"></i></div>
            <p className="text-xs font-bold text-[#E8A923] uppercase tracking-wider mb-2">24–72 hours</p>
          ...
          <div className="bg-white rounded-2xl p-6 border border-gray-100">
            <div className="w-10 h-10 flex items-center justify-center rounded-xl bg-[#E8F5F7] mb-4"><i className="ri-calendar-check-line text-[#0B7A8C] text-lg"></i></div>
            <p className="text-xs font-bold text-[#E8A923] uppercase tracking-wider mb-2">Day 30</p>
          ...
          <div className="bg-white rounded-2xl p-6 border border-gray-100">
            <div className="w-10 h-10 flex items-center justify-center rounded-xl bg-[#E8F5F7] mb-4"><i className="ri-calendar-check-line text-[#0B7A8C] text-lg"></i></div>
            <p className="text-xs font-bold text-[#E8A923] uppercase tracking-wider mb-2">Monthly → Quarterly</p>
